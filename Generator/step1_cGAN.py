...
#     logger = utils.get_logger(log_path='cachetest/training_log/', name=data_name)
#     n_critics = 5
#     n_iters = 3000
...
#             d_loss, g_loss, g_l1 = 0, 0, 0
#             csv_name = save_sequence(tensorSeq, tensorInput, tensorRealB, save_path='cachetest/', name='inducible_{}_'.format(data_name), cut_r=1)
#             utils.kmer_frequency(csv_name, '../data/{}.csv'.format(data_name), k=4, save_path='cachetest/figure/', save_name=data_name + str(i))
#             csv2fasta(csv_name, 'cachetest/gen_', 'iter_{}'.format(i))
#             torch.save(model.generator, 'check_pointstest/' + data_name + '_net_G_' + str(i) + '.pth')
#             torch.save(model.discriminator, 'check_pointstest/' + data_name + '_net_D_' + str(i) + '.pth')
#
#
